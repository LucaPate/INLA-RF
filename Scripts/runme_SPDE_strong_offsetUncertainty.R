# Title: runme_SPDE_strong_offsetUncertainty
# Author: Mario Figueira
# Date: 2025-02-20
# Description: Code combining INLA and RF, correcting the offset and tranferring the uncertainty (as a likelihood offset)
